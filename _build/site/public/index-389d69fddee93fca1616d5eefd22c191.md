...
[cite_start]To analyze datasets with mixed attributes (Nominal, Ordinal, and Numeric), a specific workflow is required to ensure each data type is processed correctly before calculating distances. [cite: 83, 84, 85]
