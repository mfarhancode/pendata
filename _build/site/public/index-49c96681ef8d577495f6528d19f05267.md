...
* **Metric Selection**: I selected the **Euclidean Distance ($h=2$)** metric, which is a special case of the **Minkowski Distance**. This measures the "straight-line" difference between flowers based on their physical dimensions[cite: 73].
